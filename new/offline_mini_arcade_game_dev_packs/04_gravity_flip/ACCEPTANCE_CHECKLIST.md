# Gravity Flip — Acceptance Checklist

## Product fit
- Prototype is playable and stable.
- It feels like movement navigation, not Pulse Orbit clone.
- Obstacle patterns are fair and readable.
- Works offline.
- Low-end performance remains stable.
- Shared stats and sessions can be integrated if promoted to production.
- Final report recommends either promote, revise, or reject.
