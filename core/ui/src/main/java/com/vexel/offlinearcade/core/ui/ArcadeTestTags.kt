...
object ArcadeTestTags {
    ...
    const val BrickVolleyDetail = "brick_volley_detail"
    const val ChallengesScreen = "challenges_screen"
    const val StatsScreen = "stats_screen"
    const val SettingsScreen = "settings_screen"

    const val BrickVolleyRoot = "brick_volley_root"
    const val BrickVolleyAimArea = "brick_volley_aim_area"
    ...
    const val BrickVolleyStartButton = "brick_volley_start_button"
    const val BrickVolleyScore = "brick_volley_score"
    const val BrickVolleyRound = "brick_volley_round"
    const val BrickVolleyRestart = "brick_volley_restart"
